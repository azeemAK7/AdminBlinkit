...
import com.example.adminblinkit.Models.Admins
...
class AuthViewModel : ViewModel() {
    ...
    fun signInWithPhoneAuthCredential(otp: String, user: Admins) {
        ...
        Utils.getAuthInstance().signInWithCredential(credential)
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    FirebaseDatabase.getInstance().reference.child("Admins").child("AdminInfo").child(user.uId.toString()).setValue(user)
